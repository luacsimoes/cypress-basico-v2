...
describe("Central de Atendimento ao Cliente TAT", function () {
  ...
  it("preenche os campos obrigatórios e envia o formulário", function () {
    ...
    cy.get('input[id="lastName"]')
      .type("Simoes")
      .should("have.value", "Simoes");
    cy.get('input[id="email"]')
      .type("simoesluana2001@gmail.com", { delay: 0 })
      .should("have.value", "simoesluana2001@gmail.com");
  ...
  it("exibe mensagem de erro ao submeter o formulário com um email com formatação inválida", function () {
    ...
    cy.get('input[id="lastName"]')
      ...
      .should("have.value", "Simoes");
    cy.get('input[id="email"]')
      .type("simoesluana2001,gmail.com")
      .should("have.value", "simoesluana2001,gmail.com");
    cy.get('textarea[id="open-text-area"]')
      .type("teste")
      .should("have.value", "teste");
  ...
  it.only("seleciona um arquivo da pasta fixtures", function () {
    cy.get('input[type="file"]').selectFile('cypress/fixtures/example.json').should('eq', 'example.json')
  });
});
